...
dotnet nuget push -s https://buildtools.ogsofttech.com:8079/v3/index.json ".\Publish\OGA.MSSQL.DAL.3.4.4.nupkg"
dotnet nuget push -s https://buildtools.ogsofttech.com:8079/v3/index.json ".\Publish\OGA.MSSQL.DAL.3.4.4.snupkg"
